...
Si lo que se adopta es un proyecto del propio método que se pliega dentro de otro, no es una migración sino una absorción, y se hace como dice `convenciones`, sección 3: su `proyecto.md` va al taller renombrado, sus registros se funden sin editar ninguna entrada, y los nombres reservados no sobreviven. Un proyecto nuevo se crea con la skill `nuevo`, con su dueño con nombre y apellido, que es bloqueante también aquí. Si el origen mezclaba dos trabajos en una carpeta, salen dos proyectos. Si el origen tenía un cuarto nivel de carpetas, ahí había dos proyectos.
